      ...
      { cartArray?.length>0?
        ...
        <table className='w-full border border-gray-400'>
          ...
          <tbody>
            { cartArray?.map((item,index)=>(
               ...
               <td className='border border-gray-100 p-3'><button onClick={()=>dispatch (removeCartItem(item?.id))} className='bg-red-700'><FontAwesomeIcon icon={faTrashCan}/></button></td>
             </tr>
            ))
             }
          </tbody>
        ...
        <div className=" pt-5 px-10">
          <div className='p-3 shadow-lg'>
            <h1 className='text-center text-3xl'>C art Summary</h1>
...
:
      ...
      <div></div>
      <div>
        <img src="https://cdni.iconscout.com/illustration/premium/thumb/empty-cart-7359557-6024626.png" alt="no image" className='w-full h-80' />
