...
function Home() {
 ...
 <button onClick={()=>dispatch(addWishlistItem(item))} className='p-2 rounded bg-red-700 text-white'><FontAwesomeIcon icon={faHeart} /></button>
            <button onClick={()=>dispatch(addItemToCart(item))} className='p-2 rounded bg-green-700 text-white'><FontAwesomeIcon icon={faCartShopping} /></button>
          </div>
        </div>
      </div>
       ))
...
//             </button>
//             <button onClick={()=>dispatch(addItemToCart(item))} className='p-2 rounded bg-green-700 text-white'>
