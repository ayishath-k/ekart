...
<div className='flex w-full '>
     <Link to={'/'}><h1 className='text-3xl'> <FontAwesomeIcon icon={faCartShopping} style={{color: "#f7f9fd",}} /> E-Kart</h1></Link>
...
{ show && <div className=' mt-4  flex md:hidden'>
     <Link to={'/wishlist'}>
        ...
        <FontAwesomeIcon icon={faHeart} className='me-2' style={{color:'red'}} /> Wishlist
        <span className='px-2 border-slate-500 bg-slate-400 rounded ms-2'>{wishlistArray?.length}</span>
          </button>
     </Link>
       <Link to={'/cart'}>
          <button className=' flex items-center p-4 py-3 border border-white rounded me-4 hover:bg-white hover:text-violet-900'>
          <FontAwesomeIcon icon={faCartShopping} className='me-2' style={{color:'green'}} /> Cart
   ...
   <div className='md:flex ms-auto hidden'>
     <Link to={'/wishlist'}>
        <button className=' flex items-center px-4 py-3 border border-white rounded me-4 hover:bg-white hover:text-violet-900'>
